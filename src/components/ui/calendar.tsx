    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 opacity-50 hover:opacity-100 transition-all hover:scale-110",
        ),
        ...
        day: cn(
          ...
          "h-11 w-11 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground transition-all hover:scale-105"
        ),
